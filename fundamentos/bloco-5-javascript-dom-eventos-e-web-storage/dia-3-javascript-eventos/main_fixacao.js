...
/* 
O motivo ocorre por causa da propriedade css no arquivo style.css na linha 69
  .tech {
    transform: translateY(-20px);
  }
Ela permite você coordenar o espaço do elemento.
*/
...
myWebpage.addEventListener('dblclick', function(){
  window.open("https://vtorvieira.github.io/","_blank");
});
